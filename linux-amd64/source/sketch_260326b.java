/* autogenerated by Processing revision 2147483647 on 2026-03-26 */
...
public class sketch_260326b extends PApplet {
...
public void setup_game(int _rows, int _columns)
{
  rows = _rows;
  columns = _columns;
...
public void keyReleased()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_260326b" };
    if (passedArgs != null) {
